    ...
    var animationsMixin = {
      ...
      methods: {
        ...
        animCertificationItems() {
          const certificationItems = gsap.utils.toArray(
            ".certification-section .certification-items li"
          );
          ...
          allPortfolioItems: [
            {
              ...
              imgUrl:
                "assets/images/projects/robofriends/robofriends-cover.png",
              projectLinks: [
                {
                  text: "Website",
          ...
          }*/,
            {
              ...
              imgUrl:
                "assets/images/projects/creativecrafts/creativeCreafts-cover.png",
              projectLinks: [
                {
      ...
      methods: {
        ...
        getCertificationItems() {
          ...
          const itemsArr = this.allCertificationItems
            .filter((item) => {
              return (
                this.certificationCurrentFilter === "All" ||
                item.category === this.certificationCurrentFilter
              );
            })
            .slice(
              this.filteredCertificationItems.length,
              this.certificationItemsPage * this.certificationItemsPerPage
            );
          ...
          if (itemsArr.length) {
            ...
            this.setNotify({
              className: "danger",
              msg: this.$refs.certificationItems.getAttribute(
                "data-no-works-msg"
              ),
              time: 3000,
            });
        ...
        contactFormValidation() {
          ...
          if (
            Object.keys(errors.name).some((err) => errors.name[err] === true)
          ) {
      ...
      computed: {
        ...
        filteredCertificationItems() {
          ...
          if (tax) {
            ...
            return this.certificationItems.filter(
              (item) =>
                this.certificationCurrentFilter === "All" ||
                item.category === this.certificationCurrentFilter
            );
