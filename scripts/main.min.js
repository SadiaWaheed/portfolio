      ...
      data() {
        return {
          ...
          allPortfolioItems: [{
            ...
            desc: {
              en: 'A starting out React project that uses Robo friends API to fetch random robot images. Alows only search options. The data displayed is hardcoded as the project does not use any databases. This peoject is to demonstrate basic react concepts.',
